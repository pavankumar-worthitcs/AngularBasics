...
@Component({
  ...
  imports: [ReactiveFormsModule,FormsModule,CommonModule,RouterModule,MatPaginatorModule,MatTableModule],
...
export class EmployeeComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   openConfirmDialog(recordId : number): void {
  ...
  loadEmployees(searchText: string): void {
      ...
      this.employeeService.searchedEmployees(searchText,this.currentPage,this.pageSize).subscribe({
